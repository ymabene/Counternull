#' Creates T statistic permutation vector for counternull distribution
#'
...
permutation_counter_t<-function(sample_data, rand_matrix,
                                       counternull_value,variable,
                                       iterations,pairs){
  # permutation vector with t statistic
